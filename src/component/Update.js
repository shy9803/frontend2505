...
function Update() {
  ...
  useEffect(()=>{
    axios.get(`https://port-0-backend-mbiobig1cd0dc4c0.sel4.cloudtype.app/goods/${g_code}`)
    //성공이면 출력
    .then(res=>{
  ...
  const handleSubmit=(e)=>{  
    ...
    axios.put(`https://port-0-backend-mbiobig1cd0dc4c0.sel4.cloudtype.app/goods/update/${g_code}`,{
